...
/* Model step function */
real32_T Subsystem_step(int8_T speed,int8_T setSpeed1,uint16_T distance)
{
  int8_T des_distance;
  real_T deltaX;
  ...
  deltaX = (Subsystem_U.In4 * Subsystem_U.In4 - Subsystem_U.In1 *
            Subsystem_U.In1) / -17.0;

  /* '<S2>:1:15' if(distance<=(des_distance + (deltaX))) */
  if (Subsystem_U.In3 <= 30.0 + deltaX) {
    /* '<S2>:1:16' if(distance <= deltaX + des_distance) && (distance  >= des_distance) */
    if ((Subsystem_U.In3 <= deltaX + 30.0) && (Subsystem_U.In3 >= 30.0)) {
      /* '<S2>:1:18' tmpSpeed1 = sqrt((speed * speed) + (2*(-acc_C)*abs((deltaX + des_distance)-distance))); */
      /* '<S2>:1:19' setSpeed = max(frontSpeed,tmpSpeed1); */
      Subsystem_DWork.setSpeed = sqrt(fabs((deltaX + 30.0) - Subsystem_U.In3) *
        -17.0 + Subsystem_U.In1 * Subsystem_U.In1);
      ...
      if (Subsystem_U.In3 < 30.0) {
        ...
        Subsystem_DWork.setSpeed = sqrt(fabs(30.0 - Subsystem_U.In3) * -17.0 +
    ...
    if (Subsystem_U.In3 > 30.0 + deltaX) {
      ...
      Subsystem_DWork.setSpeed = Subsystem_U.In1 + 1.7000000000000002;
